...
let numero = parseInt(prompt("Ejercicio 1 - Ingrese un Numero"))
...
do {
  numero2 = parseInt(prompt("Ejercicio 2 - Ingrese un Numero del 0 al 9"))
...
do {
  numeroIngresado = parseInt(prompt("Ejercicio 3 - Ingrese un numero del 1 al 100"))
...
let numero4 = parseInt(prompt("Ejercicio 4 - Ingrese un numero del 1 al 100"))
let contador4 = 0
...
let numero5 = parseInt(prompt("Ejercicio 5 - Ingrese un numero del 1 al 100"))
...
let numero7 = []
numero7[0] = parseInt(prompt("Ejercicio 7 - Ingrese un Numero"))
numero7[1] = parseInt(prompt("Ejercicio 7 - Ingrese un Numero"))
numero7[2] = parseInt(prompt("Ejercicio 7 - Ingrese un Numero"))
numero7[3] = parseInt(prompt("Ejercicio 7 - Ingrese un Numero"))
numero7[4] = parseInt(prompt("Ejercicio 7 - Ingrese un Numero"))
numero7[5] = parseInt(prompt("Ejercicio 7 - Ingrese un Numero"))
numero7[6] = parseInt(prompt("Ejercicio 7 - Ingrese un Numero"))
numero7[7] = parseInt(prompt("Ejercicio 7 - Ingrese un Numero"))
numero7[8] = parseInt(prompt("Ejercicio 7 - Ingrese un Numero"))
numero7[9] = parseInt(prompt("Ejercicio 7 - Ingrese un Numero"))
...
for (let index = 0; index < buscarImpar.length; index++) {
  ...
  if (numeroImpar !== 0) {
    console.log(buscarImpar[index] + " Es Impar")
  }
}
...
do {
  ...
  numero10 = parseInt(prompt("Ejercicio 10 - Ingrese un Numero"))
  if (numero10 % 2 === 0) {
    acumuladoPar = acumuladoPar + numero10
  } else if (numero10 % 2 !== 0) {
    acumuladoImpar = acumuladoImpar + numero10
  }
...
else if ((jugadaJugador1 === "tijera" && jugadaJugador2 === "piedra") || (jugadaJugador1 === "piedra" && jugadaJugador2 === "papel") || (jugadaJugador1 === "papel" && jugadaJugador2 === "tijera")) {
  console.log("FELICIDADSES!! " + jugador2 + " Haz GANADO")
}
